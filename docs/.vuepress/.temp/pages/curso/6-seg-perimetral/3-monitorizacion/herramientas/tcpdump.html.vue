<template><div><p>tcpdump es una herramienta sencilla disponible en Linux que permite hacer un volcado
...
aunque no podremos conocer qué hablan entre sí los ordenadores de una misma VLAN.</p>
</div></template>
