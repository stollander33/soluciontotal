...
const getSidebarData = (app, themeConfig, sorter) => {
    const generatePaths = [];
    const sidebarSorters = (0, sorter_1.getSorter)(sorter);
    ...
    const sidebarData = Object.fromEntries(generatePaths.map((path) => [
        path,
        getSidebarItems(getInfo(app, (0, shared_1.removeLeadingSlash)(path), sidebarSorters)),
    ]));
    if (app.env.isDebug)
...
const prepareSidebarData = async (app, themeConfig, sorter) => {
    const sidebarData = (0, exports.getSidebarData)(app, themeConfig, sorter);
